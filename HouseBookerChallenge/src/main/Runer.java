...
public class Runer {
	...
	public static void run() {
		...
		JOptionPane.showConfirmDialog(frame,
				"La versión " + nw.LastVersion + " de la aplicación esta disponible ¿Desea actualizar ahora?", "Actualización",
			...
			Thread thread1 = new Thread () {
				  public void run () {
					...
					JOptionPane.showMessageDialog(frame2, "Actualizació lista pulsa OK para continuar", "Actualizar", 1);
