...
public class AdminUserManagerGUI extends JDialog {
	...
	private String[]			columnNames	= new String[] { "Correo", "¿Es propietario?","Nombre", "Apellidos", "¿Está baneado?" };
						...
						if (table.getSelectedRow() != -1){
							if (!banned.get(table.getSelectedRow())){
								...
								dispose();
									...
									"Ese usuario ya está banneado.", "Error", JOptionPane.WARNING_MESSAGE);
						} else showError();
					}
				});
						...
						if (table.getSelectedRow() != -1){
							if (banned.get(table.getSelectedRow())){
								...
								dispose();
									...
									"Ese usuario no está banneado.", "Error", JOptionPane.WARNING_MESSAGE);
						} else showError();
					}
				});
	...
	private static void showError(){
		JOptionPane.showMessageDialog(null,
				"No se ha seleccionado ningún usuario.", "Error", JOptionPane.WARNING_MESSAGE);
	}
}
