...
public class VerMisReservasGUI extends JDialog {
	...
	public VerMisReservasGUI(Cliente user, GUIOperator operator) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (user.getOfertasReservadas() != null)
					BookOfferGUI.main(user.getOfertasReservadas().get(table.getSelectedRow()), user, operator, true,
							false);
			}
		});
		btnNewButton.setBounds(10, 353, 187, 32);
		...
		btnSalir.setBounds(523, 353, 187, 32);
		...
		JLabel lblAquPodrsVer = new JLabel(
				"Aqu\u00ED podr\u00E1s ver las reservas que has realizado, puedes ampliar la informaci\u00F3n o ponerte en conctacto con el due\u00F1o clicando en \"M\u00E1s informaci\u00F3n\".");
