...
public class TwitterRegistroGUI extends JDialog {
	 ...
	 * @param operator
	 */
	public TwitterRegistroGUI(boolean tipo, GUIOperator operator, TwitterAPI twitterAPI) {
		...
		}
		{
			...
			btnSeleccionarImagenDe.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					int returnVal = fc.showOpenDialog(TwitterRegistroGUI.this);
